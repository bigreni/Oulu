...
function $buo_f() {
    ...
    function() {
        ...
        city: '{"citySymbol":"FI_OULU","cityName":"Oulu","apiURL":"https://jl.oulunliikenne.fi/api/fara/","mapLink":{"name":"Oulunliikenne.fi","link":"http://Oulunliikenne.fi/","infoLink":""},"schedules":{"linesStopsLocalStorage":"linesOrStops_v1.0-oulu"},"departures":{"vehicleIcon":{"options":{"iconUrl":"https://jl.oulunliikenne.fi/images/fara_departures_icons/realtime_marker_icon_BUS.png","iconSize":"null","iconAnchor":[34,60],"zIndexOffset":9999},"markerType":"animatedMarker"},"vehicleReverseIcon":{"options":{"iconUrl":"images/fara_departures_icons/realtime_marker_icon_BUS.png","iconSize":"null","iconAnchor":[34,60],"zIndexOffset":9999},"popupOptions":{"offset":[0,-40]}},"waterTramIcon":{"options":{"iconUrl":"images/fara_departures_icons/realtime_marker_icon_WATER_TRAM.png","iconSize":"null","iconAnchor":[34,60],"zIndexOffset":9999},"markerType":"animatedMarker"},"vehiclePopupIcon":{"options":{"className":"departures-vehicle-popup-marker-fara","iconAnchor":[-26,46],"zIndexOffset":9999}},"displayVehicleIconInsteadTimeArrival":true,"stopsEditMode":false},"stopLayers":{"grouped":false}}'
    }), angular.module("concat-html", ["components/change-city/change-city.html", "components/cookies-popup/cookies-popup.html", "components/main.html", "components/map/map.html", "components/schedule/back-button/back-button.html", "components/schedule/departures/departures-table/departures-table.html", "components/schedule/departures/direction-selection/stop-directions.html", "components/schedule/departures/line-selection/departures-line-selection.html", "components/schedule/departures/main-view/main-departures-view.html", "components/schedule/departures/stop-name/departures-stop-name.html", "components/schedule/departures/timetable/timetable.html", "components/schedule/hint-panel/city-lines/city-lines.html", "components/schedule/hint-panel/hint-panel-header/hint-panel-header.html", "components/schedule/hint-panel/main-view/hint-panel.html", "components/schedule/hint-panel/search-results/search-results.html", "components/schedule/multistops-dialog/mutlistops-dialog.html", "components/schedule/selected-line/line-graph/line-graph.html", "components/schedule/selected-line/main-view/selected-line-panel.html", "components/schedule/selected-line/toggle-line-direction/toggle-line-direction.html", "components/schedule/shared/time-selection/time-selection.html", "components/schedule/sidebar/sidebar.html", "components/schedule/special-messages/special-messages.html"]), angular.module("components/change-city/change-city.html", []).run(["$templateCache", function(a) {
        a.put("components/change-city/change-city.html", '<div class="dropdown">\n    <a class="change-city-btn arrows dropdown-toggle" on-toggle="toggled(open)" title="Zmień miasto">\n        <span >{{dropdownSelectedCity | translate}}</span>\n        <span class="icon"></span>\n    </a>\n\n    <ul class="dropdown-menu city-list" role="menu">\n        <li class="item" ng-repeat="city in cities">\n            <a ng-click="changeSelectedCity(city.cityName)">\n                {{city.cityName | translate}}\n            </a>\n        </li>\n    </ul>\n\n    <select id="select-city" class="change-city-select"\n            ng-model="selectBoxCity.name"\n            ng-options="city.cityName as (city.cityName | translate) for city in cities"\n            ng-change="changeSelectedCity(selectBoxCity.name)">\n    </select>\n</div>')
        ...
        a.put("components/schedule/hint-panel/city-lines/city-lines.html", '<div class="transport-line">\n  <div bindonce ng-repeat="operator in operators"\n       bo-class="operator.info.name + \' schedule-line\'">\n    <header>\n      <span bo-class="\'sprite \' + operator.info.name"></span>\n      <h3>{{operator.info.translatedName | translate}}\n        <div ng-if="operatorsNumber > 1" class="operator-name"> - {{operator.info.operatorName}}</div>\n      </h3>\n    </header>\n\n    <div class="line-list" ng-controller="ScheduleLineListSizeCtrl">\n      <span bindonce ng-repeat="line in operator.lines | filter: {vehicleType: operator.info.name} | removeDuplicates | limitTo: linesLimit" class="angular-animate-repeat-animation">\n         <span class="line">\n           <a ng-click="selectLine(line)" bo-text="line.lineName" title="{{\'hintPanel.showLineDetails\' | translate}}"></a>\n         </span>\n          <span class="line" ng-show="!isMoreButtonVisible(operator.info.name, operator.info.operatorSymbol) && $last">\n            <a class="more" ng-click="toggleMoreLines()">\n              ...\n            </a>\n          </span>\n      </span>\n    </div>\n  </div>\n</div>\n')
    ...
    }]), angular.module("components/schedule/multistops-dialog/mutlistops-dialog.html", []).run(["$templateCache", function(a) {
        a.put("components/schedule/multistops-dialog/mutlistops-dialog.html", '<div class="multischedules">\n  <div class="multischedules__stops-search__box">\n    <div class="multischedules__stops-list__header">{{ \'selectedStop.addAStop\' | translate }}:</div>\n    <div>\n      <input class="multischedules__stops-search"\n           placeholder="{{ \'selectedStop.placeholderNameStop\' | translate  }}"\n           ng-change="inputChange()"\n           ng-model="inputValue">\n    </div>\n    <div ng-if="suggestionResult.length > 0" class="multischedules__suggestions">\n      <div class="multischedules__suggestions__row" ng-repeat="suggestion in suggestionResult" ng-click="addStopCode(suggestion.stopCode)" >\n        <!--          <span class="station-bus-icon sprite"></span>-->\n        <span class="station-name">\n          <strong>{{ suggestion.stopName }}</strong>\n          {{\' (\' + suggestion.stopCode + \')\'}}\n        </span>\n      </div>\n    </div>\n  </div>\n  <div class="multischedules__stops-list">\n    <div class="multischedules__stops-list__header">{{ \'selectedStop.activeStops\' | translate }}</div>\n    <div class="multischedules__stops-list__content">\n      <div class="multischedules__stops-list__value" ng-repeat="stop in $ctrl.stops track by $index">\n        <button ng-hide="$ctrl.stops.length <= 1" ng-click="removeStopCode($index)" class="multischedules__stops-list__btn-removed">x</button>\n        <span>\n          <strong>{{ setNameForStopCode(stop)}}</strong>\n          {{\' (\' + stop + \')\' }}\n        </span>\n      </div>\n\n    </div>\n    <button ng-click="saveStopCode()" class="multischedules__stops-list__btn-save">{{ \'selectedStop.save\' | translate }}</button>\n  </div>\n</div>\n')
    }]), angular.module("components/schedule/selected-line/line-graph/line-graph.html", []).run(["$templateCache", function(a) {
        a.put("components/schedule/selected-line/line-graph/line-graph.html", '<div class="line-graph-panel">\n  <div ng-repeat="graph in graphs track by $index" class="line-graph" ng-click="listeners.clickStop(graph)" ng-mouseover="listeners.mouseOverStop(graph)"\n       ng-mouseleave="listeners.mouseLeaveStop(graph[0].index)" title="{{\'selectedLine.showStop\' | translate}}">\n    <a ng-class="{\'row-priority\': graph[0].stop.stopName || graph[1].stop.stopName}">\n                  <span ng-class="graph[0].stopIconType">\n                    <img ng-if="graph[0].stopIconType" ng-src="https://jl.oulunliikenne.fi/images/line-graphs/{{graph[0].stopIconType}}.png" class="img_{{graph[0].stopIconType}}"/>\n                    <span ng-if="graph[0].stop.stopName" class="stop_name" ng-bind="graph[0].stop.stopName"></span>\n                  </span>\n\n                  <span ng-class="graph[1].stopIconType">\n                    <img ng-if="graph[1].stopIconType" ng-src="images/line-graphs/{{graph[1].stopIconType}}.png" class="img_{{graph[1].stopIconType}}"/>\n                    <span ng-if="graph[1].stop.stopName" class="stop_name" ng-bind="graph[1].stop.stopName"></span>\n                  </span>\n    </a>\n  </div>\n</div>\n')
    ...
    function() {
        angular.module("jakdojadeWebApp").service("ObjectManager", ["configuration", function(a) {
            ...
            }, this.displayVehicleIconInsteadTimeArrival = JSON.parse(a.city).departures.displayVehicleIconInsteadTimeArrival, this.stopsEditMode = JSON.parse(a.city).departures.stopsEditMode, this.lines = [], this.selectedLine = {}, this.selectedLine.url = "", this.lineGraph = {}, this.lineGraphResponse = {}, this.selectedStop = {}, this.lineDirection = {}, this.lineShapes = {}, this.stopsCoordinates = {}, this.setCitySymbol = function(a) {}, this.setCityName = function(a) {}, this.setCityCoordinates = function(a) {
    ...
    function() {
        angular.module("jakdojadeWebApp").service("RealtimeManager", ["TimeSelectorService", "LocationService", function(a, b) {
            this.realtimeIds = [], this.realtimeIdsByStopPassed = [], this.vehicles = [], this.vehicleGroupedArray = [], this.setObservedLinesRealtimeIds = function(a) {
                ...
                return b
            }, this.getQueryPostObject = function(a, c, d, e) {
                var f = [],
                    g = Array.isArray(b.getURLValue("stopCode")),
                    h = g ? b.getURLValue("stopCode") : b.getURLValue("stopCode").split(","),
                    i = [];
                h.forEach(function(a) {
                    i.push(a)
                }), e && (i.length = 1);
                for (var j = 0, k = a.length; j < k; j++)
                    for (var l = 0; l < i.length; l++) void 0 !== c[a[j]] ? f.push({
                        realtimeId: a[j],
                        lastLocationId: c[a[j]].lastLocationId,
                        bufferedSeconds: parseInt(c[a[j]].bufferedSeconds / 1e3),
                        predictionForStopCode: i[l]
                    }) : f.push({
                        realtimeId: a[j],
                        bufferedSeconds: 0,
                        predictionForStopCode: i[l]
    ...
    function() {
        angular.module("jakdojadeWebApp").controller("RouteCtrl", ["$scope", "$rootScope", "$route", "$timeout", "$translate", "RegisteredLanguages", "BackButtonService", "LocationService", "ObjectManager", function(a, b, c, d, e, f, g, h, i) {
            ...
            var j = i.city.citySymbol,
                ...
                x = function(b) {
                    h.setOptionalURL(h.getURLValue("stopsLayer"), "stopsLayer"), d(function() {
    ...
    function() {
        "use strict";
        angular.module("scheduleModule").controller("MultistopsDialogCtrl", ["$uibModalInstance", "stops", "stopsGroup", "$scope", "LocationService", "$timeout", "HintPanelService", function(a, b, c, d, e, f, g) {
            function h(a, b) {
                for (var c = 0; c < b.length; c++)
                    if (b[c].stopCode === a) return b[c].stopName
            }
            var i = this;
            "string" == typeof b ? i.stops = [b] : i.stops = b, d.setNameForStopCode = function(a) {
                return h(a, c)
            }, d.addStopCode = function(b) {
                i.stops.push(b);
                var c = "";
                i.stops.length > 0 && i.stops.forEach(function(a) {
                    c = c + "&stopCode=" + a
                }), e.setEntireURL(e.getDynamicPath("departures") + "?" + c + "&d=now" + e.getOptionalURL(!0)), a.close()
            }, d.removeStopCode = function(a) {
                i.stops.splice(a, 1)
            }, d.saveStopCode = function() {
                var b = "";
                i.stops.length > 0 && i.stops.forEach(function(a) {
                    b = b + "&stopCode=" + a
                }), e.setEntireURL(e.getDynamicPath("departures") + "?" + b + "&d=now" + e.getOptionalURL(!0)), a.close()
            };
            var j, k = !0,
                l = function() {
                    d.mapNoStopsFound = !1, "" !== d.inputValue && g.getStopPointsSuggestions(d.inputValue).query(function(a) {
                        d.suggestionResult = a.stops, d.suggestionResultCount = a.resultCount
                    })
                };
            d.inputChange = function() {
                k || (j && f.cancel(j), j = f(l, 400)), k = !1
            }, d.ok = function() {}, d.cancel = function() {
                a.dismiss("cancel")
            }
        }])
    }(),
    function() {
        ...
        angular.module("jakdojadeWebApp").controller("ChangeCityCtrl", ["$scope", "$rootScope", "$translate", "$timeout", "CitiesService", "LocationService", "ObjectManager", function(a, b, c, d, e, f, g) {
            a.citiesService = e, a.currentCity = g.city.cityName, a.$watch("citiesService.cityList", function() {
                ...
                a.$emit("map.changeCity"), a.changeSelectedCity = function() {
                    f.setEntireURL("/schedules/home" + f.getOptionalURL())
                }
            ...
            a.citiesService = e, a.$watchCollection("citiesService", function(e) {
                b(function() {
                    void 0 !== e.citySymbol && void 0 !== c.lineListQuery() && c.lineListQuery().query(function(b) {
                        ...
                        a.vehicleTypes = e.vehicleTypes, a.operators = e.operators, a.operatorsNumber = e.operatorsNumber, a.cityLines = e.linesArray, f.setLines(a.cityLines), a.globalMessages = d.getSpecialMessages(b, "globalAlerts")
                    })
                }, 0)
            })
        }])
    ...
    function() {
        angular.module("scheduleModule").controller("ScheduleLineListSizeCtrl", ["$scope", function(a) {
            a.linesLimit = 9, a.moreLinesButtonTitle = "hintPanel.showMoreLines", a.isMoreButtonVisible = function(b, c) {
                var d = [];
                for (var e in a.cityLines) a.cityLines[e].vehicleType === b && a.cityLines[e].operatorSymbol === c && d.push(e);
    ...
    function() {
        "use strict";
        angular.module("scheduleModule").controller("ScheduleSelectedStopCtrl", ["$scope", "$log", "$document", "$timeout", "$uibModal", "$interval", "SelectedStopService", "LocationService", "BackButtonService", "RealtimeManager", "RealtimeBufferService", "ObjectManager", "leafletData", function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
            var n, o, p = null;
            a.stops = h.getURLValue("stopCode"), a.multischedules = !1, a.stopsArray = void 0, a.stopsMarkers = new L.featureGroup([]), a.stopsEditMode = l.stopsEditMode;
            var q = function(b, c, d) {
                    var e, f, g = L.divIcon({
                        html: '<div class="departures-stop-marker"></div>'
                    });
                    f = document.createElement("DIV"), f.style.color = "#514f70", f.style.fontFamily = "'OpenSansBold', sans-serif", f.style.fontSize = "14px", f.style.padding = "10px", f.style.backgroundImage = "url('https://jl.oulunliikenne.fi/images/sprites/date-right-arrow.png')", f.style.backgroundRepeat = "no-repeat", f.style.backgroundPosition = "right center", f.innerHTML = d + "&nbsp", e = L.marker([b, c], {
                        icon: g
                    }), e.bindPopup(f), e.setZIndexOffset(1e3), a.stopsMarkers.addLayer(e)
                },
                r = function() {
                    a.stops = h.getURLValue("stopCode"), a.stopsMarkers.clearLayers(), a.setMultischedulesFlag(), g.departureQuery().query(function(b) {
                        g.setStopHistory(), a.selectedStop.stopName = g.getStopName(b), a.selectedStop.stopLines = g.getListOfLines(b), g.selectLinesByURL(a.selectedStop.stopLines), a.stopsEditMode ? a.selectedStop.stopsGroup = g.getStopVariants(b) : a.selectedStop.stopsGroup = g.getStopVariants(b).filter(function(b) {
                            return b.stopCode === a.stops
                        }), a.stopsArray = a.selectedStop.stopsGroup, a.selectedStop.stopsGroup.forEach(function(a) {
                            q(a.stopCoordinate.y_lat, a.stopCoordinate.x_lon, a.stopName)
                        }), g.setObjectManagerSelectedStopIfNotPresent(a.selectedStop.stopsGroup), B(b, !1), a.selectedStop.stopsAlerts = g.getDepartureSpecialMessages(b, "stopsAlerts"), a.selectedStop.linesAlerts = g.getDepartureSpecialMessages(b, "linesAlerts"), a.showTimeSelectionPanel = !0, v(), m.getMap().then(function(b) {
                            var c = b;
                            c.addLayer(a.stopsMarkers), c.fitBounds(a.stopsMarkers.getBounds())
                        })
                    })
                };
            a.open = function() {
                var b = e.open({
                    templateUrl: "components/schedule/multistops-dialog/mutlistops-dialog.html",
                    controller: "MultistopsDialogCtrl",
                    controllerAs: "$ctrl",
                    resolve: {
                        stops: function() {
                            return a.setStopsArray()
                        },
                        stopsGroup: function() {
                            return a.stopsArray
                        }
            ...
            }, a.setMultischedulesFlag = function() {
                Array.isArray(h.getURLValue("stopCode")) ? a.multischedules = !0 : a.multischedules = !1
            }, a.setStopsArray = function() {
                return h.getURLValue("stopCode")
            }, a.selectedStop = {}, i.setView("departures"), d(function() {
                void 0 == h.getURLValue("stopCode") ? g.extractStopCodesIfNotAvailable() : r()
            }, 200);
            var s, t = function() {
                    g.departureQuery().query(function(a) {
                        B(a, !1), v()
                    })
                },
                u = function() {
                    ...
                    }, g.getSecondsToFullMinute())
                };
            a.$on("windowInactive", function() {
                a.$apply(function() {
                    d.cancel(s), f.cancel(n), f.cancel(o), p = null, j.vehicleGroupedArray.length = 0, a.$emit("map.removeAllVehicles")
                })
            ...
            var v = function() {
                    ...
                    var c = l.city.citySymbol;
                    if (0 != b.length) {
                        var d = k.getBufferInfoForPostQuery(),
                            e = j.getQueryPostObject(b, d, c, !1);
                        j.vehicleGroupedArray.length = 0, w(e), o = f(function() {
                            var a = j.getRealtimeIdsByTimeToUpdate();
                            if (0 != a.length) {
                                var b = k.getBufferInfoForPostQuery(),
                                    d = j.getQueryPostObject(a, b, c, !0);
                                w(d)
                            }
                        }, 1e3)
                    }
                ...
                w = function(b) {
                    var c = function(b) {
                        void 0 !== b.vehicles && b.vehicles.length > 0 && k.setVehiclesInfo(b.vehicles);
                        var c = angular.copy(a.selectedStop.departures),
                            d = g.convertRealtimeDepartures(c, b);
                        angular.copy(d, a.selectedStop.departures)
                    };
                    g.realtimeQuery().query({}, new Blob([JSON.stringify(b)]), function(b) {
                        c(b), p = b, a.$emit("map.drawVehicles")
                    }, function() {
                        null !== p && c(p)
                    })
                };
            a.$on("stopName-change", function() {
                a.$emit("map.removeDepartures"), l.selectedStop = {}, k.emptyVehiclesBuffer(), j.vehicleGroupedArray.length = 0, void 0 == h.getURLValue("stopCode") ? g.extractStopCodesIfNotAvailable() : r(), a.$emit("map.removeLineRoute")
                ...
                a.$emit("map.removeVehicles"), j.vehicleGroupedArray.length = 0, x(), a.$emit("map.removeLineRoute")
            });
            var x = function() {
                a.stops = h.getURLValue("stopCode"), g.departureQuery().query(function(b) {
                    g.setStopHistory(), g.selectLinesByURL(a.selectedStop.stopLines), B(b, !1), a.selectedStop.linesAlerts = g.getDepartureSpecialMessages(b, "linesAlerts"), v()
                })
            };
            a.$on("stopCode-change", function() {
                a.$emit("map.removeDepartures"), k.emptyVehiclesBuffer(), j.vehicleGroupedArray.length = 0, l.selectedStop = {}, y(), a.$emit("map.removeLineRoute")
            });
            var y = function() {
                a.stops = a.setStopsArray(), a.setMultischedulesFlag(), g.departureQuery().query(function(b) {
                    g.setStopHistory(), B(b, !1), a.selectedStop.stopLines = g.getFilteredListOfLines(b), g.selectLinesByURL(a.selectedStop.stopLines), g.setObjectManagerSelectedStopIfNotPresent(a.selectedStop.stopsGroup), a.selectedStop.stopsAlerts = g.getDepartureSpecialMessages(b, "stopsAlerts"), a.selectedStop.linesAlerts = g.getDepartureSpecialMessages(b, "linesAlerts"), v()
                })
            };
            a.$on("dateTime-change", function() {
                a.$emit("map.removeVehicles"), z()
            });
            var z = function() {
                g.departureQuery().query(function(b) {
                    g.setStopHistory(), a.selectedStop.departures = g.convertDeparturesTable(b), g.setObjectManagerSelectedStopIfNotPresent(a.selectedStop.stopsGroup), a.selectedStop.stopsAlerts = g.getDepartureSpecialMessages(b, "stopsAlerts"), a.selectedStop.linesAlerts = g.getDepartureSpecialMessages(b, "linesAlerts"), v()
                })
            };
            a.$on("date-change", function() {
                a.$emit("map.removeVehicles"), A()
            });
            var A = function() {
                    g.departureQuery().query(function(b) {
                        B(b, !0), a.selectedStop.stopsAlerts = g.getDepartureSpecialMessages(b, "stopsAlerts"), a.selectedStop.linesAlerts = g.getDepartureSpecialMessages(b, "linesAlerts"), v()
                    })
                },
                B = function(b, c) {
                    var d, e = void 0 === h.getURLValue("d") || "now" === h.getURLValue("d");
                    if (e) a.selectedStop.departures = g.convertDeparturesTable(b), d = "Departures", a.selectedStop.isDeparturesTableVisible = !0, a.selectedStop.isTimetableVisible = !1;
                    else {
                        var f = g.getTimetableModel(b);
                        a.selectedStop.timetable = f.timetable, a.selectedStop.departures = f.departures, d = "Timetable", a.selectedStop.isTimetableVisible = !0, a.selectedStop.isDeparturesTableVisible = !1
                    }
                    c && a.$broadcast("animate-tables", d), a.selectedStop.stopsAlerts = g.getDepartureSpecialMessages(b, "stopsAlerts"), a.selectedStop.linesAlerts = g.getDepartureSpecialMessages(b, "linesAlerts")
                };
            a.$on("$destroy", function() {
                a.stopsMarkers.clearLayers(), a.$emit("map.removeDepartures"), a.$emit("map.removeLineRoute"), a.$$listeners = null, d.cancel(s), f.cancel(n), f.cancel(o), p = null, l.selectedStop = {}, j.vehicleGroupedArray.length = 0, k.emptyVehiclesBuffer(), r = null, v = null, x = null, y = null, t = null, a.selectedStop = null, a.linesLimit = null, n = null, o = null, a = null
            })
        }])
    }(),
    function() {
    ...
    function() {
        angular.module("scheduleModule").service("StopLayersService", ["$resource", "configuration", "LocationService", "ObjectManager", function(a, b, c, d) {
            ...
            this.setDepartureOnSchedulesPanel = function(a) {
                c.setEntireURL(c.getDynamicPath("departures") + "?stopName=" + a.stopName + "&stopCode=" + a.stopCode + e() + c.getOptionalURL(!0))
            }
        }])
    }(),
    function() {
        angular.module("scheduleModule").service("CitiesService", ["$resource", "LocationService", "ObjectManager", "configuration", function(a, b, c, d) {
            var e = this,
                f = c.city.citySymbol;
            this.citySymbol = c.city.citySymbol, this.cityName = c.city.cityName, this.vehicleTypes = localStorage.getItem("vehicleTypes"), this.resource = a(b.getApiURL() + "region?region_symbol=" + f, {}, {
                query: {
                    method: "GET",
                    ignoreLoadingBar: !0
                }
        ...
        angular.module("scheduleModule").factory("LinesService", ["$resource", "LocationService", "ObjectManager", function(a, b, c) {
            return {
                ...
                getLinesTypes: function(a) {
                    var b = a.operators.length,
                        d = [],
                        e = {},
                        f = [];
                    for (var g in a.operators) {
                        for (var h = 0, i = a.operators[g].availableVehicleTypes.length; h < i; h++) {
                            var j = a.operators[g].availableVehicleTypes[h];
                            e[j] = {
                                name: j,
                                translatedName: "vehicles." + j
                            }
                        }
                        var k = a.operators[g].lines;
                        for (var l in k) k[l].lineOrStop = "line", k[l].operatorSymbol = a.operators[g].operatorSymbol, k[l].cityName = c.city.cityName, d.push(k[l])
                    }
                    d.sort(function(a, b) {
                        return naturalSort(a.lineName, b.lineName)
                    });
                    var m = Object.keys(e).map(function(a) {
                        return e[a]
                    });
                    return a.operators.forEach(function(a) {
                        a.availableVehicleTypes.forEach(function(b) {
                            var c = {};
                            c.info = {
                                operatorSymbol: a.operatorSymbol,
                                operatorName: a.operatorName,
                                name: b,
                                translatedName: "vehicles." + b
                            }, c.lines = d.filter(function(c) {
                                return c.vehicleType === b && c.operatorSymbol === a.operatorSymbol
                            }), f.push(c)
                        })
                    }), {
                        linesArray: d,
    ...
    function() {
        angular.module("scheduleModule").factory("HintPanelService", ["LocationService", "$resource", "LocalStorageService", "ObjectManager", function(a, b, c, d) {
            return {
                getStopPointsSuggestions: function(c) {
                    var e = b(a.getApiURL() + "schedule/suggestions/stop-points?citySymbol=:citySymbol&query&query=:query", {}, {
                        query: {
                            method: "GET",
                            params: {
                                citySymbol: d.city.citySymbol,
                ...
                extractLines: function(a) {
                    ...
                    if (a.operatorsWithLines && a.operatorsWithLines.length > 0)
                        for (var c = 0; c < a.operatorsWithLines.length; c++)
                            for (var d = a.operatorsWithLines[c].lines, e = 0; e < d.length; e++) d[e].lineOrStop = "line", d[e].operatorSymbol = a.operatorsWithLines[c].operatorSymbol, d[e].operatorName = a.operatorsWithLines[c].operatorName, b.push(a.operatorsWithLines[c].lines[e]);
                    return b
                },
                setSelectedLineURL: function(b) {
                    ...
                    a.setEntireURL(a.getDynamicPath("lineStops") + "?lineId=" + b.lineId + c() + a.getOptionalURL(!0))
                },
                setDepartureURL: function(b) {
                    var d = function() {
                        ...
                        e = c.getDepartures(b);
                    void 0 != e ? a.setEntireURL(a.getDynamicPath("departures") + e) : a.setEntireURL(a.getDynamicPath("departures") + "?stopName=" + b.stopName + d() + a.getOptionalURL(!0))
                }
            }
        }])
    }(),
    ...
    function() {
        "use strict";
        angular.module("jakdojadeWebApp").factory("LocationService", ["$location", "configuration", function(a, b) {
            var c = {};
            return c.optionalURL = {}, {
                getApiURL: function() {
                    return JSON.parse(b.city).apiURL
                },
                ...
                getFirstParameter: function(a, b) {
                    var d = "?",
                        e = "&";
                    return a || 1 !== Object.keys(c.optionalURL).length && !b ? e : d
                },
                getOptionalURL: function(a) {
                    var b = "",
                        d = !0;
                    for (var e in c.optionalURL) {
                        var f = this.getFirstParameter(a, d);
                        d = !1, b = b + f + [e] + "=" + c.optionalURL[e]
                    }
                    return b
                },
                removeValueFromOptionalURL: function(a) {
                    delete c.optionalURL[a]
                },
    ...
    function() {
        angular.module("scheduleModule").service("SelectedLineService", ["LocationService", "ObjectManager", "CurrentDatesService", "LineGraphService", "$interval", function(a, b, c, d, e) {
            this.selectedLine = {}, this.firstTimeLoad = function(c) {
                ...
                this.selectedLine.startAndEndDirection = [f, g], a.setEntireURL(a.getDynamicPath("lineStops") + "?lineId=" + a.getURLValue("lineId") + "&lineDirection=" + g + "&d=" + a.getURLValue("d") + a.getOptionalURL(!0))
    ...
    function() {
        angular.module("scheduleModule").service("LineGraphService", ["$resource", "LineGraphConverterService", "CurrentDatesService", "LocationService", "TimeSelectorService", "ObjectManager", function(a, b, c, d, e, f) {
            this.getLineGraph = function() {
                ...
                var b = a.stopCode,
                    c = a.stopName;
                f.setSelectedStop(a), d.setEntireURL(d.getDynamicPath("departures") + "?stopName=" + c + "&stopCode=" + b + "&lineId=" + d.getURLValue("lineId") + "&d=" + d.getURLValue("d") + d.getOptionalURL(!0))
        ...
        angular.module("scheduleModule").factory("SelectedStopService", ["SelectedStopConverterService", "TimetableService", "SelectedStopListOfLinesService", "SelectedStopDirectionService", "SelectedStopAPIQueryService", "DeparturesRealtimeConverter", "SpecialMessagesService", "LocationService", "LocalStorageService", "TimeSelectorService", "ObjectManager", "RealtimeManager", function(a, b, c, d, e, f, g, h, i, j, k, l) {
            return {
                ...
                setObjectManagerSelectedStopIfNotPresent: function(a) {
                    var b = h.getURLValue("stopCode");
                    if (0 === Object.getOwnPropertyNames(k.selectedStop).length)
                        for (var c = 0, d = a.length; c < d; c++)
                            if (Array.isArray(b))
                                for (var e = 0, f = b.length; e < f; e++) a[c].stopCode === b[e] && k.setSelectedStop(a[c]);
                            else a[c].stopCode == h.getURLValue("stopCode") && k.setSelectedStop(a[c])
                },
                ...
                convertDeparturesTable: function(b) {
                    return a.convertDeparturesTable(b)
                },
                ...
                goToTimetableView: function(a) {
                    for (var b = 0, c = a.length; b < c; b++)
                        if (a[b].lineId == h.getURLValue("lineId")) {
                            h.storePreviousURL(h.getEntireURL()), h.setEntireURL(h.getDynamicPath("timetable") + "?lineId=" + a[b].lineId + "&directionCode=" + a[b].directionCode + "&stopCode=" + a[b].stopCode + h.getOptionalURL(!0));
                            break
                        }
                },
            ...
            return {
                ...
                extractStopCodes: function() {
                    void 0 == c.getURLValue("stopCode") && d.getTypedValue(c.getURLValue("stopName")).query(function(a) {
                        ...
                        c.setEntireURL(c.getLocationPath() + "?stopName=" + c.getURLValue("stopName") + g(b[1]) + f(c.getURLValue("lineId"), "lineId") + c.getOptionalURL(!0))
                    })
                },
            ...
            return {
                convertDeparturesTable: function(d) {
                    ...
                    for (var m = 0; m < d.stops.length; m++) {
                        ...
                        for (var n = d.stops[m].stopName, o = d.stops[m].lines, p = 0, q = o.length; p < q; p++)
                            if (f.lineName = o[p].lineName, f.lineId = o[p].lineId, f.lineDirectionName = o[p].lineDirectionName, f.vehicleType = o[p].vehicleType, o[p].departures)
                                for (var r = 0; r < o[p].departures.length; r++) {
                                    var s;
                                    s = o[p].departures[r].departureRealtime ? o[p].departures[r].departureRealtime : o[p].departures[r].departureSchedule, f.departure = s.substring(11, 16), f.timeZone = s.substring(23, 28);
                                    var t = s.substring(0, 4),
                                        u = s.substring(5, 7),
                                        v = s.substring(8, 10);
                                    a.setMinutesToSubtract(f), o[p].departures[r].journeyAlerts ? f.journeyMessage = o[p].departures[r].journeyAlerts[0].messageHtml : f.journeyMessage = "", o[p].departures[r].cancelled ? f.cancelled = o[p].departures[r].cancelled : f.cancelled = !1, f.cleanedDeparture = f.departure.replace(/[^a-zA-Z0-9! ]+/g, ""),
                                        function() {
                                            var a = new Date;
                                            a.setHours(a.getUTCHours() + parseInt(f.timeZone.substring(2, 3), 10)), a.getDate() < parseInt(v, 10) && (f.cleanedDeparture = parseInt(f.cleanedDeparture.substring(0, 2), 10) + 24 + f.cleanedDeparture.substring(2, 4))
                                        }(), f.minutesToArrival = a.convertMinutesToArrival(f.cleanedDeparture, f.minutesToSubtract), f.minutesOrHours = "minutes";
                                    for (var w = f.minutesToArrival >= 0, x = 0; x < c.realtimeIdsByStopPassed.length; x++)
                                        if (f.realtimeId !== !1 && c.realtimeIdsByStopPassed[x].realtimeId === f.realtimeId) {
                                            0 == c.realtimeIdsByStopPassed[x].stopPassed && (w = !0);
                                            break
                                        } if (w && f.minutesToArrival <= 420 || void 0 !== b.getURLValue("dateTime")) {
                                        a.setDeparturesRealtimeIfAvailable(f, o, p, r), f.minutesToArrival >= 60 && a.convertMinutesToHours(f);
                                        var y = t + u + v,
                                            z = parseFloat(y + f.cleanedDeparture.toString() + "." + m + p.toString() + r.toString());
                                        g === !1 && (f.isToday = !1, f.minutesToArrival = o[p].departures[r].departureSchedule.substring(8, 10) + "." + o[p].departures[r].departureSchedule.substring(5, 7)), f.minutesToArrival < 0 && (f.minutesToArrival = "00");
                                        var A = o[p].departures[r].departureSchedule.substring(11, 16),
                                            B = o[p].departures[r].departureRealtime ? o[p].departures[r].departureRealtime.substring(11, 16) : void 0,
                                            C = o[p].departures[r].boardingRestriction;
                                        if (void 0 === o[p].departures[r].headingTextOverride) var D = o[p].lineDirectionName;
                                        else var D = o[p].departures[r].headingTextOverride;
                                        e.push({
                                            stopName: n,
                                            cancelled: f.cancelled,
                                            departure: A,
                                            departureRealtime: B,
                                            boardingRestriction: C,
                                            headingTextOverride: D,
                                            lineName: f.lineName,
                                            lineId: f.lineId,
                                            ...
                                            isToday: f.isToday,
                                            trackingValue: f.cleanedDeparture + f.lineName + f.lineDirectionName + z
                                        })
                                    }
                                }
                    }
    ...
    function() {
        angular.module("scheduleModule").service("SelectedStopListOfLinesService", ["LocationService", function(a) {
            ...
            var b = function(b, c) {
                ...
                d === !0 && e !== !0 && (g = g + "&lineId=" + b), h = h.replace(new RegExp(a.getOptionalURL(!0)), ""), h = h.replace("&stopCode=" + a.getURLValue("stopCode"), ""), h = h + "&stopCode=" + a.getURLValue("stopCode"), void 0 !== a.getURLValue("d") && (h = h.replace("&d=" + a.getURLValue("d")), h = h + "&d=" + a.getURLValue("d")), h = h.replace("undefined", ""), a.setEntireURL(h + g + a.getOptionalURL(!0))
            };
                ...
                for (var e, f, g, h, i, j = [], k = b.stops, l = 0, m = k.length; l < m; l++) {
                    ...
                    if ("string" == typeof a.getURLValue("stopCode")) {
                        ...
                        for (var p = a.getURLValue("stopCode"), q = 0; q < p.length; q++)
                            if (p[q] == k[l].stopCode)
                                for (var o = 0; o < n; o++) e = k[l].lines[o].lineName, f = k[l].lines[o].directionCode, g = k[l].lines[o].vehicleType,
                                    h = k[l].lines[o].lineId, i = k[l].stopCode, j.push({
                                        lineName: e,
                                        stopCode: i,
                                        lineId: h,
                                        vehicleType: g,
    ...
    function() {
        angular.module("scheduleModule").service("SelectedStopDirectionService", ["LocationService", "ObjectManager", function(a, b) {
            ...
            var c = function(b) {
                ...
                a.setEntireURL(a.getDynamicPath("departures") + "?stopName=" + a.getURLValue("stopName") + i(d) + "&stopCode=" + b.stopCode + j() + a.getOptionalURL(!0))
            }
        }])
    }(),
    function() {
                ...
                getDeparturesFromLocalStorage: function(a) {
                    ...
                    if (localStorage.getItem("departures"))
                        for (var d = JSON.parse(localStorage.getItem("departures")), e = c.city.citySymbol + "." + a.stopName, f = 0; f < d.length; f++) {
                            var g = new URLSearchParams(d[f].stopURL),
                                h = g.get("stopCode");
                            if (d[f].stopDetails == e && a.stopsCodes.indexOf(h) > -1) return b(d[f].stopURL)
                        }
                }
            }
        }])
        ...
        angular.module("scheduleModule").factory("BackButtonService", ["SelectedLineService", "LocationService", function(a, b) {
            ...
            return {
                ...
                returnToLastView: function() {
                    ...
                    void 0 === a ? b.returnToHomeView() : b.setEntireURL(a + b.getOptionalURL(a.includes("?")))
                },
        ...
        a.controller("MapCtrl", ["$scope", "$rootScope", "$timeout", "MapService", "LocationService", "ObjectManager", "leafletEvents", "leafletData", "configuration", function(a, b, c, d, e, f, g, h, i) {
            angular.extend(a, {
                ...
                h.getMap().then(function(a) {
                    return a.options.minZoom = 9, a.attributionControl.setPrefix('<a href="http://leafletjs.com" title="A JS library for interactive maps">Leaflet</a> | &copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors')
                })
                ...
                controller: ["$scope", function(c) {
                    ...
                    c.$on("hintPanel.location", function(b, c) {
                        a.getMap().then(function(a) {
                            h = !0, d = a, d.on("dragend", function(a) {
                                d.stopLocate(), d.locate({
                                    setView: !1,
                                    maxZoom: 17,
                                    watch: !0,
            ...
            return {
                ...
                link: function(h) {
                    var i, j, k, l = {},
                        ...
                        n = {},
                        o = JSON.parse(b.city),
                        p = L.icon(o.departures.vehicleIcon.options),
                        q = L.icon(o.departures.waterTramIcon.options),
                        r = L.icon(o.departures.vehicleReverseIcon.options),
                        s = function(a) {
                            var b = function() {
                                a.closePopup()
                            };
                            a.onPreviousCourse === !0 ? (a.off("click", b), a.bindPopup(h.onPreviousCoursePopupContent, o.departures.vehicleReverseIcon.popupOptions)) : a.on("click", b)
                        },
                        t = function(a) {
                            return "VEHICLE_TYPE_WATER_TRAM" === a.vehicleType ? q : a.onPreviousCourse === !0 ? r : p
                        },
                        u = function(a, b) {
                            if ((null === l[b] || void 0 === l[b]) && a[0].stopPassed !== !0) {
                                ...
                                l[b] = L[o.departures.vehicleIcon.markerType](g.getLatLngs(), {
                                    icon: t(a[0]),
                                    zIndexOffset: 9999,
                                    angle: f,
                                    autoStart: !1,
                                    interval: 0
                                }), l[b].realtimeId = a[0].realtimeId, l[b].lineId = a[0].lineId, l[b].onPreviousCourse = a[0].onPreviousCourse, s(l[b]);
                                var h = L.divIcon({
                                        className: o.departures.vehiclePopupIcon.options.className,
                                        iconSize: null,
                                        iconAnchor: o.departures.vehiclePopupIcon.options.iconAnchor,
                                ...
                                m[b] = L.animatedMarker(i.getLatLngs(), {
                                    icon: h,
                                    autoStart: !1,
                                    zIndexOffset: 9999
                                }), m[b].realtimeId = a[0].realtimeId, m[b].lineId = a[0].lineId, e.getMap().then(function(a) {
                                    l[b].addTo(a), m[b].addTo(a)
                                })
                            }
                        },
                        v = function(a) {
                            ...
                            if (void 0 !== b[a] && b[a].length > 0)
                                if (b[a][0].stopPassed === !0) void 0 !== l[a] && (h.$emit("selectedStop.removeVehicleOnStopPassed", a), e.getMap().then(function(b) {
                                    void 0 !== a && b.eachLayer(function(c) {
                                        c.realtimeId === a && b.removeLayer(c)
                                    })
                                }), g.removeVehicle(a), delete l[a], delete m[a], delete n[a]);
                                else if (void 0 !== l[a]) {
                                n[a] = !0;
                                var c = b[a][0].coordinate.y_lat,
                                    d = b[a][0].coordinate.x_lon,
                                    f = b[a][0].pathAngleNDeg,
                                    i = l[a]._latlng.lat,
                                    j = l[a]._latlng.lng;
                                l[a]._latlngs[0].lat = i, l[a]._latlngs[0].lng = j, l[a]._latlngs[1].lat = c, l[a]._latlngs[1].lng = d, void 0 === l[a].previousCoordinates && (l[a].previousCoordinates = []);
                                for (var k = !0, o = 0; o < l[a].previousCoordinates.length; o++) c !== l[a].previousCoordinates[o].lat && d !== l[a].previousCoordinates[o].lng || (k = !1);
                                if (l[a].previousCoordinates.push({
                                        lat: c,
                                        lng: d
                                    }), l[a].options.previousAngle = l[a].options.angle, l[a].options.angle = f, l[a].options.interval = b[a][0].delayMillis, l[a].options.realtimeId = a, l[a].options.lastLocationId = b[a][b[a].length - 1].locationId, l[a].onPreviousCourse !== b[a][0].onPreviousCourse) {
                                    var p = t(b[a][0]);
                                    l[a].setIcon(p), l[a].onPreviousCourse = b[a][0].onPreviousCourse, s(l[a]), p = null
                                }
                                if (l[a].options.onEnd = function() {
                                        v(a)
                    ...
                    h.$on("selectedStop.drawDepartures", function() {
                        e.getMap().then(function(a) {
                            i = a, i.on("zoomstart", function() {
                                if (null !== l || void 0 !== l)
                                    for (var a in l) {
                                        var b = m[l[a].realtimeId];
                                        l[a].stop(i, b)
                                    }
                            }), i.on("zoomend", function() {
                                if (null !== l || void 0 !== l)
                                    for (var a in l) l[a].resume()
                            })
                        })
                    }), h.$on("selectedStop.drawVehicles", function() {
                        for (var a = g.getVehiclesBuffer(), b = f.realtimeIds, c = 0, d = b.length; c < d; c++) void 0 !== a[b[c]] && (u(a[b[c]], b[c]), n[b[c]] !== !0 && v(b[c]))
                                ...
                                if (l.hasOwnProperty(c)) {
                                    for (var d = !0, e = 0, f = b.length; e < f; e++)
                                        if (c === b[e]) {
                                            d = !1;
                                            break
                                        } void 0 !== l[c] && d === !0 && (i.removeLayer(l[c]), i.removeLayer(m[c]), delete l[c], delete m[c], g.removeVehicle(c))
                                }
                        })
                    }), h.$on("selectedStop.removeVehicles", function() {
                        d.removeVehicles(l, m, i)
                    }), h.$on("selectedStop.removeAllVehicles", function() {
                        e.getMap().then(function(a) {
                            i = a;
                            for (var b in l) i.removeLayer(l[b]), i.removeLayer(m[b]), delete l[b], delete m[b]
                        })
                    }), h.$on("selectedStop.removeDepartures", function() {
                        e.getMap().then(function(a) {
                            i = a, void 0 !== j && null !== j && i.removeLayer(j);
                            for (var b in l) i.removeLayer(l[b]), i.removeLayer(m[b]);
                            j = null, k = null, l = {}, m = {}
                        })
                        ...
                        c("map.onPreviousCourse").then(function(a) {
                            h.onPreviousCoursePopupContent = a;
                            for (var b in l) l[b].closePopup(), s(l[b])
                        })
                    })
                }
            }
    ...
    function() {
        angular.module("scheduleModule").directive("departuresStopName", ["LocationService", function(a) {
            return {
                restrict: "E",
                scope: {
                    name: "="
    ...
    function() {
        angular.module("scheduleModule").directive("drawDeparturesTable", ["LocationService", "ObjectManager", function(a, b) {
            return {
                restrict: "E",
                scope: {
                    departures: "="
                ...
                link: function(c) {
                    c.displayVehicleIconInsteadTimeArrival = b.displayVehicleIconInsteadTimeArrival, c.multischedules = !1, c.setMultischedulesFlag = function() {
                        Array.isArray(a.getURLValue("stopCode")) ? c.multischedules = !0 : c.multischedules = !1
                    }, c.checkIfMultischedulesView = function() {
                        return !!Array.isArray(a.getURLValue("stopCode"))
                    }, c.setMultischedulesFlag()
                }
            }
        }])
    }(),
